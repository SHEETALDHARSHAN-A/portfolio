...
const skills = ["React", "Next.js", "Node.js", "Python", "AI", "ML", "Tailwind", "TypeScript"];
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        >
                            ...
                            <p className="text-sm md:text-base lg:text-lg font-light leading-relaxed text-slate-300">
                                I am a passionate <span className="text-white font-medium">Full-Stack Developer</span> & <span className="text-purple-400 font-medium italic">AI Enthusiast</span> from India, dedicated to the art of building software that feels alive. My journey is fueled by a curiosity for how <span className="text-white">intelligent systems</span> can simplify our complex world.
                            </p>

                            <p className="mt-3 text-[11px] md:text-xs text-slate-400 leading-relaxed">
                                I don't just write code; I craft scalable architectures and <span className="gradient-text font-medium italic">stunning digital narratives</span>. From the logic of Next.js to the hidden wonders of AI, I'm always looking for the next boundary to push. Code is my poetry, and innovation is my canvas.
                            </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <div className="pl-3 truncate">
                                    <span className="text-slate-400">name:</span> <span className="text-amber-200">"SheetalDharshan A"</span>,
                                </div>
                                <div className="pl-3 truncate">
                                    <span className="text-slate-400">passion:</span> <span className="text-amber-200">"Building"</span>,
                                </div>
                                <div className="pl-3">
                                    <span className="text-slate-400">mode:</span> <span className="text-amber-200">"Developement"</span>
                                </div>
                            ...
                            >
                                <div className="text-purple-400 text-lg mb-1 leading-none">“</div>
                                <p className="text-[10px] md:text-[11px] text-slate-400 italic leading-snug">
                                    Innovation is the ability to see change as an opportunity, not a threat.
                                </p>
                                <div className="text-purple-400 text-lg mt-1 text-right leading-none">”</div>
                            </motion.div>
                        </div>
                    </div>
                </div>
